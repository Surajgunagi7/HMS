...
const AddDoctor = () => {
    ...
    const onSubmit = async (data) => {
      try {
        const response = await doctorService.addDoctor(data); 
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-6 shadow rounded-md max-h-screen">
      <h2 className="text-xl font-bold mb-6">Add Doctor</h2>
      <div className='flex justify-between'>
          <div className='w-full mr-10'>
            <div className='mb-5'> 
              <label className="block font-medium text-lg mb-2" htmlFor='name'>Name</label>
              <input
                type="text"
                id="name"
            ...
            <div className='mb-5'>
              <label className="block font-medium text-lg mb-2" htmlFor='specialization'>Specialization</label>
              <input
                type="text"
                id="specialization"
            ...
            <div className='mb-5'>
              <label className="block font-medium mb-2 text-lg" htmlFor='email'>Email</label>
              <input
                type="email"
                id="email"
          ...
          <div className='w-full'>
            ...
            <div className='mb-5'>
              <label className="block font-medium mb-2 text-lg" htmlFor='education'>Education</label>
              <input
                type="text"
                id="education"
            ...
            <div className='mb-5'>
              <label className="block font-medium mb-2 text-lg" htmlFor='about'>About</label>
              <textarea
                id="about"
